...
export class ResetConfirmScene implements Scene {
  ...
  render(ctx: CanvasRenderingContext2D): void {
    ...
    ctx.fillText("Reset Pet?", 400, y + 24);
    ctx.font = "20px system-ui, sans-serif";
    ctx.fillText(`This will reset ${this.profileName}'s pet`, 400, y + 90);
    ctx.fillStyle = "rgb(255,100,100)";
    ctx.fillText("back to an egg. All progress will be lost!", 400, y + 120);
