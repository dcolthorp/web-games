...
const games: Game[] = [
  {
    ...
    path: "./drawing-boss-mania/index.html",
    genre: "Boss Doodle",
  ...
  },
  {
    id: "stickman-fight",
    name: "Stickman Fight",
    path: "./stickman-fight/index.html",
    genre: "Ragdoll Brawl",
  ...
  },
  {
    ...
    path: "../games/the-settings-game/index.html",
  ...
  },
  {
    id: "feed-your-fire",
    name: "Feed Your Fire",
    path: "./feed-your-fire/index.html",
    genre: "Pet Pyro",
...
function renderGameList(): void {
  ...
  list.innerHTML = games
    .map(
      (game) => `
      <li>
        <a class="game-card games2-game-card" data-game-id="${game.id}" href="${game.path}" aria-label="${game.name}">
