...
export const skins: Skin[] = [
  { id: "plain", name: "Plain", blurb: "What you have always worn.", price: 0, colour: "#f0efe6", speed: 1, fogBonus: 0, iceGrip: false, windProof: false, waterProof: false, shield: 0 },
  { id: "runner", name: "Runner", blurb: "A third faster on your feet.", price: 40, colour: "#ffd54a", speed: 1.33, fogBonus: 0, iceGrip: false, windProof: false, waterProof: false, shield: 0 },
  { id: "lantern", name: "Lantern", blurb: "See four tiles further in the dark.", price: 55, colour: "#ffb347", speed: 1, fogBonus: 4, iceGrip: false, windProof: false, waterProof: false, shield: 0 },
  { id: "boots", name: "Snow Boots", blurb: "Ice cannot slide you, wind cannot push you.", price: 60, colour: "#9fd8ff", speed: 1, fogBonus: 0, iceGrip: true, windProof: true, waterProof: false, shield: 0 },
  { id: "diver", name: "Diver", blurb: "Water no longer slows you down.", price: 50, colour: "#5ce0d6", speed: 1, fogBonus: 0, iceGrip: false, windProof: false, waterProof: true, shield: 0 },
  { id: "armour", name: "Iron Shell", blurb: "Take one hit for free. Refills at every flag.", price: 80, colour: "#c0c6cc", speed: 0.92, fogBonus: 0, iceGrip: false, windProof: false, waterProof: false, shield: 1 },
  { id: "champion", name: "Champion", blurb: "Faster, tougher, and sees further. Everything at once.", price: 200, colour: "#ff7bd5", speed: 1.2, fogBonus: 3, iceGrip: true, windProof: true, waterProof: true, shield: 1 },
];
