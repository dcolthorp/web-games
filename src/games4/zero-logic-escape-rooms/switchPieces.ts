...
export const SWITCH_PIECES_BUILT = 2;

// Piece 1 is the plate the switch sits in; piece 2 is the lever that flips.
...
// Drawn centered on (x, y). At scale 1 the plate is 60 × 90 and the lever 18 × 52.
